...
export default function NavBar() {
  return (
    <div>
      <Navbar>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" height={50}>
        ...
        <NavbarBrand href="/">FlashCard 3000</NavbarBrand>

        <Nav className="me-auto">
          <NavItem>
            <NavLink href="/components/">111</NavLink>
          </NavItem>
          <NavItem>
            <NavLink href="https://github.com/reactstrap/reactstrap">222</NavLink>
          </NavItem>
        </Nav>
